...
load_root:
	...
	div WORD[BPBBytesPerSector]						; ax contains length of root directory in sectors
	xchg ax, cx
...
; load into 32 bit mode
	...
	or eax, 1
	mov cr0, eax									; enable Protected Mode on next jmp
...
; READ_FAIL:		db "Fail to "
; READ_SUCCESS:	db 0x0a, 0x0d, 0
